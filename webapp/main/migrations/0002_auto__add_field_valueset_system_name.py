...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ValueSet.system_name'
        db.add_column('valueset', 'system_name',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ValueSet.system_name'
        db.delete_column('valueset', 'system_name')
