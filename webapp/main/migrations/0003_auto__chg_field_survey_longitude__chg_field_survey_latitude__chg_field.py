...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Survey.longitude'
        db.alter_column('survey', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6))

        # Changing field 'Survey.latitude'
        db.alter_column('survey', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6))

        # Changing field 'Location.longitude'
        db.alter_column('location', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6))

        # Changing field 'Location.latitude'
        db.alter_column('location', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Survey.longitude'
        db.alter_column('survey', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Survey.latitude'
        db.alter_column('survey', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Location.longitude'
        db.alter_column('location', 'longitude', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'Location.latitude'
        db.alter_column('location', 'latitude', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
